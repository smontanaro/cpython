...
- Instruction implementation - As of this writing (April 2020), only a
  38 instructions have been implemented.  (The PyVM instruction set
  currently contains 119 instructions.)  Since the PyVM instruction
  set has grown significantly over the past two decades, it makes
  sense that this be tackled by multiple people in parallel.  (easy to
  medium)
