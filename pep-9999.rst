...
[#dynmont]_, [#instpage]_ and remains true today.  Running
Pyperformance using a development version of Python 3.9 showed that
the top four opcodes executed (LOAD_FAST, LOAD_CONST, STORE_FAST and
LOAD_GLOBAL) accounted for nearly half of all executed
instructions. (The complete table of frequencies is in `Appendix -
Opcode Frequencies`_.)

While such a change doesn't qualify as low hanging fruit, it seems
