...
- Instruction implementation - As of this writing (April 2020), only a
  about 25 instructions have been implemented.  (The PyVM instruction
  set currently contains 119 instructions.)  Since the PyVM instruction
...
- LOAD_GLOBAL_REF opcache - Haven't yet figured out how to exercise
  the opcache code in this instruction.
