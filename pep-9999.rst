...
- Proper register allocation - See [#issue1] (hard)

- Support code in modules and classes - See [#issue2] (easy)

- Proper AST-based implementation - See [#issue3] (hard - but perhaps
  not for someone with experience with the existing compiler)

- Complete instruction implementation - See [#issue4] (easy to medium)
