...
BINOPS = {
    ...
    opmap["BINARY_AND_REG"]: '&',
    opmap["BINARY_FLOOR_DIVIDE_REG"]: '//',
    opmap["BINARY_LSHIFT_REG"]: '<<',
    opmap["BINARY_MATRIX_MULTIPLY_REG"]: '@',
    opmap["BINARY_MODULO_REG"]: '%',
    opmap["BINARY_MULTIPLY_REG"]: '*',
    opmap["BINARY_OR_REG"]: '|',
    opmap["BINARY_POWER_REG"]: '**',
    opmap["BINARY_RSHIFT_REG"]: '>>',
    opmap["BINARY_SUBSCR_REG"]: '[]',
    opmap["BINARY_SUBTRACT_REG"]: '-',
    opmap["BINARY_TRUE_DIVIDE_REG"]: '/',
    opmap["BINARY_XOR_REG"]: '^',
    opmap["INPLACE_ADD_REG"]: '+=',
    opmap["INPLACE_AND_REG"]: '&=',
    opmap["INPLACE_FLOOR_DIVIDE_REG"]: '//=',
    opmap["INPLACE_LSHIFT_REG"]: '<<=',
    opmap["INPLACE_MATRIX_MULTIPLY_REG"]: '@=',
    opmap["INPLACE_MODULO_REG"]: '%=',
    opmap["INPLACE_MULTIPLY_REG"]: '*=',
    opmap["INPLACE_OR_REG"]: '|=',
    opmap["INPLACE_POWER_REG"]: '**=',
    opmap["INPLACE_RSHIFT_REG"]: '>>=',
    opmap["INPLACE_SUBTRACT_REG"]: '-=',
    opmap["INPLACE_TRUE_DIVIDE_REG"]: '/=',
    opmap["INPLACE_XOR_REG"]: '^=',
}
