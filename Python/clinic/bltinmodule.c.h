...
PyDoc_STRVAR(builtin_regcompile__doc__,
"regcompile($module, /, source, filename, mode, flags=0,\n"
"           dont_inherit=False, optimize=-1, *, _feature_version=-1)\n"
"--\n"
"\n"
"Compile source using register compiler into a code object that can be executed by exec() or eval().\n"
"\n"
...
"regcompile; if absent or false these statements do influence the compilation,\n"
"in addition to any features explicitly specified.");

#define BUILTIN_REGCOMPILE_METHODDEF    \
    {"regcompile", (PyCFunction)(void(*)(void))builtin_regcompile, METH_FASTCALL|METH_KEYWORDS, builtin_regcompile__doc__},

static PyObject *
builtin_regcompile_impl(PyObject *module, PyObject *source,
                        PyObject *filename, const char *mode, int flags,
                        int dont_inherit, int optimize, int feature_version);

static PyObject *
builtin_regcompile(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"source", "filename", "mode", "flags", "dont_inherit", "optimize", "_feature_version", NULL};
    static _PyArg_Parser _parser = {NULL, _keywords, "regcompile", 0};
    PyObject *argsbuf[7];
    ...
    if (!PyUnicode_Check(args[2])) {
        _PyArg_BadArgument("regcompile", "argument 'mode'", "str", args[2]);
        goto exit;
    }
...
skip_optional_kwonly:
    return_value = builtin_regcompile_impl(module, source, filename, mode, flags, dont_inherit, optimize, feature_version);
...
/*[clinic end generated code: output=799cfb55379a8528 input=a9049054013a1b77]*/
